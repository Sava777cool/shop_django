...
from .models import Jewelry, Watch, Category, LatestProducts, Customer, Cart, CartProduct
...
class MakeOrderView(CartMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            messages.add_message(request, messages.INFO, 'Thanks for your order! The manager will contact you')
